...
public class Plan13 {
	...
	void setElements(String tle) {
		...
		satNum = Integer.parseInt(line.substring(2, 7)); // SatNum
		...
		IN = Double.parseDouble(line.substring(8, 16)); // Inclination
		RA = Double.parseDouble(line.substring(17, 25)); // Right
															// Ascension
		EC = Double.parseDouble("0." + line.substring(26, 33)); // Eccentricity
	 ...
	 * @param M2_in
	 *            Decay Rate (BSTAR Drag Term I think, Found by process of
	 *            elimination)
	 * @param RV_in
	 *            Orbit Number (Rev number at Epoch)
	 * @param ALON_in
	 *            Sat Attitude, deg
	 */
