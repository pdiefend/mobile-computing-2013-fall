// Constantes m�s utilizadas por las clases del paquete
...
class SGP_Constants
{
	...
	// Radio ecuatorial de la tierra en kil�metros
	...
	// C�digo de inializaci�n del modelo Deep-Space
	final static int dpinit = 1;
	// C�digo secular del modelo Deep-Space
	final static int dpsec = 2;
	// C�digo peri�dico del modelo Deep-Space
	final static int dpper = 3;
	// Radio solar en kil�metros
	final static double sr = 696000.0;
	// Unidad Astron�mica (distancia de la Tierra al Sol en kil�metros)
	final static double AU = 1.49597870e8;
	// Minutos por dia
	final static double xmnpda = 1440.0;
	// Segundos por dia
	final static double secday = 86400.0;
	// Rotaciones de la tierra por d�a sideral (no-constante)
