...
public class PassFinderISS {
  ...
  public static void main(String[] args) {
    ...
    if (args.length != 7){
      InformeHtml.error("Error: El n�mero de argumentos no es adecuado."); // number of arguements no es bueno
      InformeHtml.uso();
      InformeHtml.fin();
      System.exit(1);
    }
      ...
      try {
        ...
        InformeHtml.error("Error: El argumento Dias (6�) no es un n�mero.");
        InformeHtml.uso();
        InformeHtml.fin();
        System.exit(1);
      }
      try {
        ...
        InformeHtml.error("Error: El argumento Maxima Elevaci�n umbral (7�) no es un n�mero.");
        InformeHtml.uso();
        InformeHtml.fin();
        System.exit(1);
      }
    ...
    if (status){
      ...
      InformeHtml.error("    Archivo no disponible en disco. Falta conexi�n a Internet.");
      InformeHtml.uso();
      InformeHtml.fin();
      System.exit(1);
    }
